...
public class CameraController : MonoBehaviour
{
    ...
    public static float camera_animate_duration = 4.0f;     // 카메라를 이용해서 에니메이션 연출할 때 쓸 지속 시간
    ...
    void Update()
    {
        ...
        moveVector.y = Mathf.Clamp(moveVector.y, 3, 5);       // 카메라 y축 고정(3~5사이의 값으로 제한)
        ...
        else
        {
            ...
            // 전환 값을 서서히 증가 시킵니다. (프레임 시간 / 에니메이션 시간)
