...
public interface IPool
{
    ...
    // Action 은 void 형태의 함수 처리를 진행할 때 쓰는 대리자
    // Func 는 return 값이 있는 형태의 함수 처리를 진행할 때 쓰는 대리자

    // 3-2. default parameter
    // 메소드의 도입부 () 안에는 매개 변수를 작성할 수 있습니다.
    // 매개변수에 값을 적어놓으면 default parameter가 돼서 
...
public class PoolManager : MonoBehaviour
{
    ...
    public IPool Pooling(string path)
    {
        ...
        // Add_Pool 이 public 이 아닌 private 으로 짜인 이유
        // Pooling 을 통해 Add_Pool 기능 사용 가능
    ...
    private GameObject Add_Pool(string path)
    {
        ...
        // 전달받은 경로명 + Pool 로 빈 오브젝트가 생성될 것입니다.
